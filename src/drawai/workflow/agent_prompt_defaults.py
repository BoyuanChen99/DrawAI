...
PAGE_SPEC_PROCESSING_OPERATIONS = {
    "no_process": PageSpecProcessingOperation(
        ...
        avoid_when=(
            ...
            "images, or elements that require a dedicated processor before SVG Compose."
        ),
    ),
    ...
    "image_generate": PageSpecProcessingOperation(
        ...
        choose_when=(
            ...
            "test DAG, use it for several semantically clear representation/future icons instead of defaulting "
            "all such assets to crop."
        ),
        avoid_when=(
    ...
    "image_edit": PageSpecProcessingOperation(
        ...
        choose_when=(
            ...
            "the crop is visibly low-resolution but the original composition should stay recognizable."
        ),
        avoid_when=(
